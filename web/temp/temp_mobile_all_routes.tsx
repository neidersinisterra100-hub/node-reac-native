...
export default function AllRoutesScreen() {
  ...
  const loadRoutes = async () => {
    try {
      setLoading(true);
      // routeService.getAll itera sobre empresas visibles. 
      // Si eres User, debería iterar sobre empresas públicas.
    ...
    >
      <View style={styles.cardHeader}>
          ...
          <View style={{flex: 1}}>
              ...
              <Text style={styles.cardSubtitle}>Toca para ver viajes disponibles</Text>
          </View>
      </View>
    </TouchableOpacity>
  );
